package com.example.administrator.app148_alertdialog;
...
public class MainActivity extends Activity {
    ...
    public void multiChoice(View view) {
        AlertDialog.Builder builder=new AlertDialog.Builder(MainActivity.this)
                .setTitle("多选列表项对话框")
                .setIcon(R.drawable.tools)
                .setMultiChoiceItems(items,new boolean[4],null);
        setNegativeButton(builder);
        setPositiveButton(builder);
        builder.create().show();
    }
    ...
    public void customView(View view) {
        TableLayout loginFrom=(TableLayout)getLayoutInflater().inflate(R.layout.login,null);
        AlertDialog.Builder builder=new AlertDialog.Builder(MainActivity.this)
                .setTitle("自定义View对话框")
                .setIcon(R.drawable.tools)
                .setView(loginFrom)
